# Runbook — sdkwork-kernel deploy / upgrade / rollback (EN)
...
targets. Image reference: `registry.sdkwork.com/apps/sdkwork-kernel-standalone:0.1.0`
...
install syncs the bundle to `/opt/deploy/sdkwork-kernel/bundle`, loads the image, starts
